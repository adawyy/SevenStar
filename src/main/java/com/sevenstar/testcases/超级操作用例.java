...
import com.sevenstar.task.超级操作任务;
...
public class 超级操作用例 extends 七星彩基础用例 {

    //定义任务
    private 公用任务 公用;
    private 后台公用任务 后台公用任务集;
    private 超级操作任务 超级操作任务集;
    ...
    public void 超级操作测试() throws Exception {
        ...
        后台公用任务集.点击菜单("越级操作");
        超级操作任务集.点击修改账号(ht_登录信息.get("大股东"),"大股东");
        超级操作任务集.修改账号信息(ht_大股东设置);
        asBaseCore.pause(1000);
        超级操作任务集.点击账号列表();

        超级操作任务集.点击账号(ht_登录信息.get("大股东"),"大股东");
        超级操作任务集.点击修改账号(ht_登录信息.get("股东"),"股东");
        超级操作任务集.修改账号信息(ht_股东设置);
        超级操作任务集.点击父账号(ht_登录信息.get("大股东"),"大股东");

        超级操作任务集.点击账号(ht_登录信息.get("股东"),"股东");
        超级操作任务集.点击修改账号(ht_登录信息.get("总代理"),"总代理");
        超级操作任务集.修改账号信息(ht_总代理设置);
        超级操作任务集.点击父账号(ht_登录信息.get("股东"),"股东");

        超级操作任务集.点击账号(ht_登录信息.get("总代理"),"总代理");
        超级操作任务集.点击修改账号(ht_登录信息.get("代理"),"代理");
        超级操作任务集.修改账号信息(ht_代理设置);
        超级操作任务集.点击父账号(ht_登录信息.get("总代理"),"总代理");

        超级操作任务集.点击账号(ht_登录信息.get("代理"),"代理");
        超级操作任务集.点击修改账号(ht_登录信息.get("会员"),"会员");
        超级操作任务集.点击父账号(ht_登录信息.get("代理"),"代理");
