...
//        后台公用任务集.点击菜单("报表");
//        报表任务集.验证报表(ht_登录信息.get("大股东"),"大股东","5",false,false);
//        报表任务集.点击账号名(ht_登录信息.get("大股东"),"大股东");
//        报表任务集.验证报表(ht_登录信息.get("股东"),"股东","5",false,false);
//        报表任务集.点击账号名(ht_登录信息.get("股东"),"股东");
//        报表任务集.验证报表(ht_登录信息.get("总代理"),"总代理","5",false,false);
//        报表任务集.点击账号名(ht_登录信息.get("总代理"),"总代理");
//        报表任务集.验证报表(ht_登录信息.get("代理"),"代理","5",false,false);
//        报表任务集.点击账号名(ht_登录信息.get("代理"),"代理");
//        报表任务集.验证报表(ht_登录信息.get("会员"),"会员","5",false,false);
...
//    }
    ...
    public void 结账后报表验证() throws Exception {
        公用.快速登录(ht_登录信息.get("总监"),ht_登录信息.get("总监密码"));
        后台公用任务集.点击菜单("报表");
        报表任务集.验证报表(ht_登录信息.get("大股东"),"大股东","1",true,true);
        报表任务集.点击账号名(ht_登录信息.get("大股东"),"大股东");
        报表任务集.验证报表(ht_登录信息.get("股东"),"股东","1",true,true);
        报表任务集.点击账号名(ht_登录信息.get("股东"),"股东");
        报表任务集.验证报表(ht_登录信息.get("总代理"),"总代理","1",true,true);
        报表任务集.点击账号名(ht_登录信息.get("总代理"),"总代理");
        报表任务集.验证报表(ht_登录信息.get("代理"),"代理","1",true,true);
        报表任务集.点击账号名(ht_登录信息.get("代理"),"代理");
        报表任务集.验证报表(ht_登录信息.get("会员"),"会员","1",true,true);
        报表任务集.点击账号名(ht_登录信息.get("会员"),"会员");
    }
