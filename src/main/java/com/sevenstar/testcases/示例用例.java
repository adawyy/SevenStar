...
public class 示例用例 extends 七星彩基础用例 {
    ...
    public void 结账前报表验证() throws Exception {
        ...
        公用.快速登录(ht_登录信息.get("总监"),ht_登录信息.get("总监密码"));
        后台公用任务集.点击菜单("报表");
        报表任务集.验证报表(ht_登录信息.get("大股东"),"大股东",次数,false);
        报表任务集.点击账号名(ht_登录信息.get("大股东"),"大股东");
        报表任务集.验证报表(ht_登录信息.get("股东"),"股东",次数,false);
        报表任务集.点击账号名(ht_登录信息.get("股东"),"股东");
        报表任务集.验证报表(ht_登录信息.get("总代理"),"总代理",次数,false);
        报表任务集.点击账号名(ht_登录信息.get("总代理"),"总代理");
        报表任务集.验证报表(ht_登录信息.get("代理"),"代理",次数,false);
        报表任务集.点击账号名(ht_登录信息.get("代理"),"代理");
        报表任务集.验证报表(ht_登录信息.get("会员"),"会员",次数,false);
